...
def getRecipeCat(floor,deco):
  switcher = {
    ...
    "interstellar":interstellar,"interstellarprestige":interstellarprestige,      
    "punk":punk,"punkprestige":punkprestige,      
    "african":african,"africanprestige":africanprestige,     
    "profession":profession,"professionprestige":professionprestige,     
    "bugs":bugs,"bugsprestige":bugsprestige,
    "winter":winter,"winterprestige":winterprestige,
    "spring":spring,"springprestige":springprestige,
    "autumn":autumn,"autumnprestige":autumnprestige,
    "school":school,"schoolprestige":schoolprestige,
    "dogs":dogs,"dogsprestige":dogsprestige,
    "diner":diner,"dinerprestige":dinerprestige,
    "sports":sports,"sportsprestige":sportsprestige,
    ...
    "smallpets":smallpets,"smallpetsprestige":smallpetsprestige,
    "hippie":hippie,"hippieprestige":hippieprestige,
    "pirates":pirates,"piratesprestige":piratesprestige,
    "hospital":hospital,"hospitalprestige":hospitalprestige,
    "playground":playground,"playgroundprestige":playgroundprestige,
    "shipwreck":shipwreck,"shipwreckprestige":shipwreckprestige,
    "gnomes":gnomes,"gnomesprestige":gnomesprestige,
    "deconstructivism":deconstructivism,"deconstructivismprestige":deconstructivismprestige,
    "caveman":caveman,"cavemanprestige":cavemanprestige,
    "miniature":miniature,"miniatureprestige":miniatureprestige,
    "wrestling":wrestling,"wrestlingprestige":wrestlingprestige,
    "laundromat":laundromat,"laundromatprestige":laundromatprestige,
    "infant":infant,"infantprestige":infantprestige,
    "tropicalfruits":tropicalfruits,"tropicalfruitsprestige":tropicalfruitsprestige,
    "gelatin":gelatin,"gelatinprestige":gelatinprestige,
    ...
    "aquarium":aquarium,"aquariumprestige":aquariumprestige,
    "archery":archery,"archeryprestige":archeryprestige,
    ...
    "carousel":carousel,"carouselprestige":carouselprestige,
    "catcafe":catcafe,"catcafeprestige":catcafeprestige,
    "corn":corn,"cornprestige":cornprestige,
    "costumedcats":costumedcats,"costumedcatsprestige":costumedcatsprestige,
    "duck":duck,"duckprestige":duckprestige,
    "freshfruit":freshfruit,"freshfruitprestige":freshfruitprestige,
    #"garfield":garfield,
    "gingerbreadhouse":gingerbreadhouse,"gingerbreadhouseprestige":gingerbreadhouseprestige,
    "hatcats":hatcats, "hatcatsprestige":hatcatsprestige,
    "hotpot":hotpot,"hotpotprestige":hotpotprestige,
    "knitdoll":knitdoll,"knitdollprestige":knitdollprestige,
...
def interstellarprestige(deco):
  switcher = {
    1: "6 Needles, 2 Silver, 210 Coins",
    2: "10 Orb, 2 Silver, 210 Coins",
    3: "2 Sparkles, 2 Fire, 680 Coins",
    4: "6 Sparkles, 6 Silver, 680 Coins",
    5: "8 Sparkles, 4 Pendants, 1100 Coins",
    6: "6 Silver, 4 Pendants, 1100 Coins",
    7: "8 Water, 6 Fire, 2200 Coins"
  }
  return switcher.get(deco,"")
...
def punkprestige(deco):
  switcher = {
    1: "6 Ribbon, 2 Water, 220 Coins",
    2: "6 Needles, 2 Silver, 220 Coins",
    3: "6 Silver, 4 Water, 710 Coins",
    4: "6 Silver, 4 Water, 710 Coins",
    5: "8 Sparkles, 8 Water, 1100 Coins",
    6: "4 Pendant, 2 Fire, 1100 Coins",
    7: "2 Water, 2 Fire, 2 Necklace, 2300 Coins"
  }
  return switcher.get(deco,"")
...
def africanprestige(deco):
  switcher = {
    1: "2 Water, 10 Amethyst, 230 Coins",
    2: "2 Water, 10 Amethyst, 230 Coins",
    3: "4 Water, 6 Silver, 740 Coins",
    4: "2 Gold, 2 Pendant, 740 Coins",
    5: "4 Water, 4 Gold, 1200 Coins",
    6: "6 Water, 10 Sparkles, 1200 Coins", #WENDY check?
    7: "8 Sparkles, 8 Gold, 8 Silver, 2400 Coins"
  }
  return switcher.get(deco,"")
...
def professionprestige(deco):
  switcher = {
    1: "2 Water, 12 Amethyst, 240 Coins",
    2: "2 Water, 10 Ribbon, 240 Coins",
    3: "6 Sparkles, 2 Gold, 780 Coins",
    4: "2 Waterstone, 4 Water, 780 Coins",
    5: "2 Waterstone, 2 Firestone, 1200 Coins",
    6: "4 Waterstone, 2 Fire, 1200 Coins",
    7: "4 Waterstone, 8 Water, 4 Fire, 2500 Coins"
  }
  return switcher.get(deco,"")
...
def bugsprestige(deco):
  switcher = {
    1: "14 Amethyst , 10 Needles, 250 Coins",
    2: "22 Amethyst, 18 Ribbon, 250 Coins",
    3: "2 Waterstone, 2 Pendant, 810 Coins",
    4: "2 Waterstone, 14 Needles, 810 Coins",
    5: "2 Firestone, 8 Silver, 1300 Coins",
    6: "8 Sparkles, 4 Gold, 1300 Coins",
    7: "4 Waterstone, 8 Water, 4 Fire, 2600 Coins"
  }
  return switcher.get(deco,"")
...
def winterprestige(deco):
  switcher = {
    1: "16 Orb , 18 Amethyst, 260 Coins",
    2: "10 Needles, 14 Ribbon, 260 Coins",
    3: "12 Sparkles, 12 Needles, 840 Coins",
    4: "2 Waterstone, 4 Water, 840 Coins",
    5: "2 Waterstone, 6 Pendants, 1300 Coins",
    6: "2 Firestone, 12 Silver, 1300 Coins", #WENDY check?
    7: "6 Waterstone, 6 Water, 4 Fire, 2700 Coins"
  }
  return switcher.get(deco,"")
...
def springprestige(deco):
  switcher = {
    1: "16 Orb, 20 Amethyst, 270 Coins",
    2: "2 Water, 6 Needles, 270 Coins",
    3: "4 Water, 2 Gold, 870 Coins",
    4: "2 Gold, 4 Pendants, 870 Coins",
    5: "10 Water, 2 Fire, 1400 Coins",
    6: "4 Gold, 4 Pendants, 1400 Coins",
    7: "4 Waterstone, 2 Elementstone, 4 Firestone, 2800 Coins" #WENDY check
  }
  return switcher.get(deco,"")
...
def autumnprestige(deco):
  switcher = {
    1: "4 Sparkles, 14 Amethyst, 280 Coins",
    2: "2 Water, 4 Sparkles, 280 Coins",
    3: "2 Waterstone, 2 Fire, 910 Coins",
    4: "4 Water, 2 Fire, 910 Coins",
    5: "12 Sparkles, 2 Firestone, 1400 Coins",
    6: "2 Firestone, 10 Silver, 1400 Coins",
    7: "6 Waterstones, 2 Elementstone, 4 Firestones, 2900 Coins" #WENDY check
  }
  return switcher.get(deco,"")
...
def schoolprestige(deco):
  switcher = {
    1: "2 Water, 12 Orb, 290 Coins",
    2: "14 Orb, 10 Needles, 290 Coins",
    3: "2 Fire, 18 Needles, 940 Coins",
    4: "2 Waterstone, 6 Water, 940 Coins",
    5: "2 Pendant, 2 Elementstone, 1500 Coins",
    6: "14 Sparkles, 2 Firestone, 1500 Coins",
    7: "6 Waterstone, 2 Elementstone, 4 Firestone, 3000 Coins" #WENDY check
  }
  return switcher.get(deco,"")
...
def dogsprestige(deco):
  switcher = {
    1: "2 Water, 14 Orbs, 300 Coins",
    2: "2 Water, 4 Sparkles, 300 Coins",
    3: "2 Fire, 20 Needles, 970 Coins",
    4: "2 Fire, 2 Firestone, 970 Coins",
    5: "2 Sparkle, 2 Elementstone, 1500 Coins",
    6: "4 Waterstone, 2 Fire, 1500 Coins",
    7: "8 Water, 6 Pendants, 2 Necklace, 3100 Coins"
  }
  return switcher.get(deco,"")
...
def dinerprestige(deco):
  switcher = {
    1: "2 Water, 4 Sparkles, 310 Coins",
    2: "4 Needles, 4 Silver, 310 Coins",
    3: "2 Firestone, 2 Silver, 990 Coins",
    4: "2 Waterstone, 6 Water, 990 Coins",
    5: "6 Pendants, 2 Firestone, 1600 Coins",
    6: "4 Sparkles, 2 Elementstone, 1600 Coins",
    7: "4 Waterstone, 2 Elementstone, 4 Firestone, 3200 Coins"
  }
  return switcher.get(deco,"")
...
def sportsprestige(deco):
  switcher = {
    1: "2 Water, 4 Sparkles, 320 Coins",
    2: "2 Water, 10 Needles, 320 Coins",
    3: "2 Pendant, 2 Firestone, 1000 Coins",
    4: "8 Sparkles, 2 Fire, 1000 Coins",
    5: "4 Waterstone, 12 Sparkles, 1600 Coins",
    6: "2 Fire, 2 Elementstone, 1600 Coins",
    7: "10 Water, 4 Fire, 2 Necklace, 3300 Coins"
  }
  return switcher.get(deco,"")
...
def desertprestige(deco):
  switcher = {
    1: "2 Water, 4 Silver, 330 Coins",
    2: "16 Orbs, 12 Needles, 330 Coins",
    3: "6 Water, 10 Sparkles, 1000 Coins",
    4: "8 Water, 2 Gold, 1000 Coins",
    5: "2 Gold, 2 Elementstone, 1700 Coins",
    6: "8 Sparkles, 8 Pendants, 1700 Coins",
    7: "4 Waterstone, 2 Elementstone, 4 Firestone, 3400 Coins"
  }
  return switcher.get(deco,"")
...
def dinosaursprestige(deco):
  switcher = {
    1: "4 Sparkles, 10 Needles, 340 Coins",
    2: "2 Pendant, 2 Orb, 340 Coins",
    3: "10 Sparkles, 10 Silver, 1100 Coins",
    4: "10 Sparkles, 2 Fire, 1100 Coins",
    5: "8 Water, 4 Fire, 1700 Coins",
    6: "2 Elementstone, 6 Silver, 1700 Coins",
    7: "6 Waterstone, 4 Fire, 4 Firestone, 3500 Coins"
  }
  return switcher.get(deco,"")
...
def hairsalonprestige(deco):
  switcher = {
    1: "2 Water, 20 Orbs, 350 Coins",
    2: "16 Ribbon, 4 Silver, 350 Coins",
    3: "6 Water, 10 Silver, 1100 Coins",
    4: "4 Pendants, 2 Fire, 1100 Coins",
    5: "12 Water, 16 Sparkles, 1800 Coins",
    6: "2 Fire, 2 Elementstone, 1800 Coins",
    7: "12 Water, 8 Pendant, 2 Necklace, 3600 Coins" #WENDY wiki said 1800 but this is my best guess
  }
  return switcher.get(deco,"")
...
def heavymetalprestige(deco):
  switcher = {
    1: "14 Orb, 4 Silver, 360 Coins",
    2: "14 Orb, 4 Silver, 360 Coins",
    3: "8 Water, 8 Sparkles, 1200 Coins",
    4: "4 Pendants, 2 Fire, 1200 Coins",
    5: "4 Pendants, 2 Elementstone, 1800 Coins",
    6: "4 Water, 4 Firestone, 1800 Coins",
    7: "6 Waterstone, 2 Elementstone, 4 Firestone, 3700 Coins"
  }
  return switcher.get(deco,"")
...
def westernprestige(deco):
  switcher = {
    1: "8 Needles, 4 Silver, 370 Coins",
    2: "2 Water, 4 Sparkles, 370 Coins",
    3: "8 Water, 2 Fire, 1200 Coins",
    4: "2 Waterstone, 2 Firestone, 1200 Coins",
    5: "8 Water, 4 Fire, 1900 Coins",
    6: "4 Water, 4 Firestone, 1900 Coins",
    7: "6 Waterstone, 2 Elementstone, 4 Firestone, 3800 Coins"
  }
  return switcher.get(deco,"")
...
def racingprestige(deco):
  switcher = {
    1: "6 Sparkles, 16 Ribbon, 380 Coins",
    2: "2 Water, 6 Sparkles, 380 Coins",
    3: "4 Waterstone, 4 Silver, 1200 Coins",
    4: "2 Fire, 10 Silver, 1200 Coins",
    5: "18 Sparkles, 18 Silver, 1900 Coins",
    6: "4 Pendant, 2 Elementstone, 1900 Coins",
    7: "8 Waterstone, 2 Elementstone, 4 Firestone, 3900 Coins"
  }
  return switcher.get(deco,"")
...
def smallpetsprestige(deco):
  switcher = {
    1: "2 Gold, 6 Silver, 560 coins",
    2: "2 Gold, 6 Silver, 560 coins",
    3: "2 Pendant, 2 Necklace, 1700 Coins",
    4: "2 Pendant, 2 Necklace, 1700 Coins",
    5: "8 Waterstone, 6 Fire, 2900 Coins",
    6: "20 Water, 2 Necklace, 2900 Coins",
    7: "8 Waterstone, 8 Fire, 6 Firestone, 5800 Coins"
  }
  return switcher.get(deco,"") 
...
def hippieprestige(deco):
  switcher = {
    1: "2 Gold, 6 Silver, 570 coins",
    2: "2 Gold, 6 Silver, 570 coins",
    3: "4 Water, 2 Necklace, 1800 Coins",
    4: "4 Water, 2 Necklace, 1800 Coins",
    5: "10 Water, 10 Fire, 2900 Coins",
    6: "2 Elementstone, 6 Firestone, 2900 Coins",
    7: "2 Artifact, 2 Elementstone, 6 Firestone, 5900 Coins"
  }
  return switcher.get(deco,"") 
...
def piratesprestige(deco):
  switcher = {
    1: "2 Waterstone, 2 Fire, 580 coins",
    2: "2 Waterstone, 2 Fire, 580 coins",
    3: "2 Elementstone, 2 Firestone, 1800 Coins",
    4: "2 Elementstone, 2 Firestone, 1800 Coins",
    5: "8 Waterstone, 6 Fire, 3000 Coins",
    6: "12 Pendant, 2 Necklace, 3000 Coins",
    7: "8 Gold, 12 Pendant, 4 Necklace, 6000 Coins"
  }
  return switcher.get(deco,"") 
...
def hospitalprestige(deco):
  switcher = {
    1: "12 Sparkles, 12 Needles, 590 coins",
    2: "12 Sparkles, 12 Needles, 590 coins",
    3: "8 Gold, 8 Silver, 1800 Coins",
    4: "8 Gold, 8 Silver, 1800 Coins",
    5: "12 Water, 10 Fire, 3000 Coins",
    6: "6 Waterstone, 6 Firestone, 3000 Coins",
    7: "10 Waterstone, 4 Elementstone, 6 Firestone, 6100 Coins"
  }
  return switcher.get(deco,"") 
...
def playgroundprestige(deco):
  switcher = {
    1: "4 Water, 2 Fire, 600 coins",
    2: "4 Water, 2 Fire, 600 coins",
    3: "6 Waterstone, 4 Fire, 1900 Coins",
    4: "6 Waterstone, 4 Fire, 1900 Coins",
    5: "4 Elementstone, 4 Firestone, 3100 Coins",
    6: "12 Water, 10 Fire, 3100 Coins",
    7: "8 Waterstone, 6 Fire, 4 Necklace, 6300 Coins"
  }
  return switcher.get(deco,"") 
...
def shipwreckprestige(deco):
  switcher = {
    1: "2 Gold, 6 Silver, 610 coins",
    2: "2 Gold, 6 Silver, 610 coins",
    3: "4 Pendant, 2 Necklace, 1900 Coins",
    4: "4 Pendant, 2 Necklace, 1900 Coins",
    5: "6 Waterstone, 6 Firestone, 3200 Coins",
    6: "2 Artifact, 2 Elementstone, 3200 Coins",
    7: "2 Artifact, 4 Elementstone, 4 Firestone, 6400 Coins"
  }
  return switcher.get(deco,"")
...
def gnomesprestige(deco):
  switcher = {
    1: "2 Waterstone, 2 Fire, 620 coins",
    2: "2 Waterstone, 2 Fire, 620 coins",
    3: "2 Elementstone, 4 Firestone, 1900 Coins",
    4: "2 Elementstone, 4 Firestone, 1900 Coins",
    5: "12 Pendant, 2 Necklace, 3200 Coins",
    6: "8 Waterstone, 8 Fire, 3200 Coins",
    7: "10 Waterstone, 8 Fire, 8 Firestone, 6500 Coins"
  }
  return switcher.get(deco,"") 
...
def deconstructivismprestige(deco):
  switcher = {
    1: "2 Waterstone, 2 Fire, 630 coins",
    2: "2 Waterstone, 2 Fire, 630 coins",
    3: "2 Elementstone, 4 Firestone, 2000 Coins",
    4: "2 Elementstone, 4 Firestone, 2000 Coins",
    5: "12 Pendant, 2 Necklace, 3300 Coins",
    6: "8 Waterstone, 8 Fire, 3300 Coins",
    7: "10 Waterstone, 8 Fire, 8 Firestone, 6600 coins"
  }
  return switcher.get(deco,"") 
...
def cavemanprestige(deco):
  switcher = {
    1: "2 Waterstone, 2 Fire, 640 coins",
    2: "2 Waterstone, 2 Fire, 640 coins",
    3: "2 Elementstone, 4 Firestone, 2000 coins",
    4: "2 Elementstone, 4 Firestone, 2000 coins",
    5: "12 Pendant, 2 Necklace, 3300 coins",
    6: "8 Waterstone, 8 Fire, 3300 coins",
    7: "10 Waterstone, 8 Fire, 8 Firestone, 6700 coins"
  }
  return switcher.get(deco,"") 
...
def miniatureprestige(deco): #WENDY coins
  switcher = {
    1: "2 Waterstone, 2 Fire, 650 coins",
    2: "2 Waterstone, 2 Fire, 650 coins",
    3: "2 Elementstone, 4 Firestone, 2000 Coins",
    4: "2 Elementstone, 4 Firestone, 2000 Coins",
    5: "12 Pendant, 2 Necklace, 3400 Coins",
    6: "8 Waterstone, 8 Fire, 3400 Coins",
    7: "10 Waterstone, 8 Fire, 8 Firestone, 6800 Coins"
  }
  return switcher.get(deco,"") 
...
def wrestlingprestige(deco): #WENDY coins
  switcher = {
    1: "2 Waterstone, 2 Fire, 660 coins",
    2: "2 Waterstone, 2 Fire, 660 coins",
    3: "2 Elementstone, 4 Firestone, 2100 Coins",
    4: "2 Elementstone, 4 Firestone, 2100 Coins",
    5: "12 Pendant, 2 Necklace, 3400 Coins",
    6: "8 Waterstone, 8 Fire, 3400 Coins",
    7: "10 Waterstone, 8 Fire, 8 Firestone, 6900 Coins"
  }
  return switcher.get(deco,"") 
...
def laundromatprestige(deco): #WENDY coins except I'm sure of 5-7
  switcher = {
    1: "2 Waterstone, 2 Fire, 670 coins",
    2: "2 Waterstone, 2 Fire, 670 coins",
    3: "2 Elementstone, 4 Firestone, 2100 Coins",
    4: "2 Elementstone, 4 Firestone, 2100 Coins",
    5: "12 Pendant, 2 Necklace, 3500 Coins",
    6: "8 Waterstone, 8 Fire, 3500 Coins",
    7: "10 Waterstone, 8 Fire, 8 Firestone, 7000 Coins"
  }
  return switcher.get(deco,"") 
...
def infantprestige(deco): #WENDY coins only unsure of 1,2
  switcher = {
    1: "2 Waterstone, 2 Fire, 680 coins",
    2: "2 Waterstone, 2 Fire, 680 coins",
    3: "2 Elementstone, 4 Firestone, 2200 Coins",
    4: "2 Elementstone, 4 Firestone, 2200 Coins",
    5: "12 Pendant, 2 Necklace, 3500 Coins",
    6: "8 Waterstone, 8 Fire, 3500 Coins",
    7: "10 Waterstone, 8 Fire, 8 Firestone, 7100 Coins"
  }
  return switcher.get(deco,"") 
...
def tropicalfruitsprestige(deco): 
  switcher = {
    1: "2 firestone, 2 pendant, 690 coins",
    2: "2 firestone, 2 pendant, 690 coins",
    3: "2 Elementstone, 6 gold, 30 orb, 2200 Coins",
    4: "2 Elementstone, 6 gold, 30 orb, 2200 Coins",
    5: "2 Necklace, 8 waterstone, 3600 Coins",
    6: "2 artifact, 2 fire, 30 orb, 3600 Coins",
    7: "2 artifact, 8 waterstone, 8 firestone, 7200 Coins"
  }
  return switcher.get(deco,"") 
...
def gelatinprestige(deco):
  switcher = {
    1: "4 firestone, 4 pendant, 700 coins",
    2: "4 firestone, 4 pendant, 700 coins",
    3: "4 Elementstone, 10 gold, 40 orb, 2200 Coins",
    4: "4 Elementstone, 10 gold, 40 orb, 2200 Coins",
    5: "4 Necklace, 12 waterstone, 3600 Coins",
    6: "4 artifact, 4 fire, 40 orb, 3600 Coins",
    7: "4 artifact, 12 waterstone, 12 firestone, 7300 Coins"
  }
  return switcher.get(deco,"") 
...
def archeryprestige(deco): #WENDY recipes unconfirmed
  switcher = {
    1: "10 Wood, 100 Coins",
    2: "10 String, 100 Coins",
    3: "4 Metal, 2 Needle, 320 Coins",
...
def carouselprestige(deco):
  switcher = {
    1: "10 Wood, 100 Coins",
    2: "10 String, 100 Coins",
    3: "4 Metal, 2 Needle, 320 Coins",
    4: "4 Metal, 2 Needle, 320 Coins",
    5: "14 String, 6 Ribbons, 520 Coins",
    6: "16 Metal, 2 Needle, 520 Coins",
    7: "8 Ribbons, 6 Needles, 2 Sparkles, 1000 Coins"
  }
  return switcher.get(deco,"")
...
def gingerbreadhouseprestige(deco): 
  switcher = {
    1: "10 Wood, 100 Coins",
    2: "10 String, 100 Coins",
    3: "4 Metal, 2 Needle, 320 Coins",
...
def streetperformerprestige(deco): 
  switcher = {
    1: "10 Wood, 100 Coins",
    2: "10 String, 100 Coins",
    3: "4 Metal, 2 Needle, 320 Coins",
